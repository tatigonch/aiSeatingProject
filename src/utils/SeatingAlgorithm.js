...
2. Среди людей с ПЛОХИМ зрением, найди самых ВЫСОКИХ. Их НЕЛЬЗЯ ставить в одну пару — разнеси по краям:
   - СТРОГОЕ ОГРАНИЧЕНИЕ: Первый самый высокий с плохим зрением → пара 1, позиция A.
   - СТРОГОЕ ОГРАНИЧЕНИЕ: Второй самый высокий с плохим зрением → пара 3, позиция B.
   Они НЕ должны быть в одной паре! Остальные с плохим зрением заполняют оставшиеся места в парах 1-3.
   ВАЖНО: в пары 1-3 попадают ТОЛЬКО люди с плохим зрением.
